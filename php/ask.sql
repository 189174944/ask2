...
CREATE TABLE `ask_artical` (
  ...
  `is_anonymous` tinyint(1) unsigned DEFAULT '0' COMMENT '是否匿名发布',
...
-- ----------------------------
BEGIN;
INSERT INTO `ask_artical` VALUES ('1', '1', '1', '人工智能的局限性', '内容', null, '5', '0', '1', null, '0', '0', null, '2018-05-03 14:33:57', '2018-05-03 14:30:14', '2018-05-14 14:33:24', null), ('2', '1', '2', '测试问题', '问题内容', null, '3', '0', '0', null, '0', '0', null, null, '2018-05-08 15:16:17', '2018-05-15 10:03:09', null), ('3', '1', '1', '测试文章', '文章内容', null, '1', '0', '0', null, '0', '0', null, null, '2018-05-08 15:16:20', '2018-05-08 15:16:22', null);
COMMIT;
...
-- ----------------------------
--  Records of `ask_artical_collect_dir`
-- ----------------------------
BEGIN;
INSERT INTO `ask_artical_collect_dir` VALUES ('1', '1', '科技');
COMMIT;
...
-- ----------------------------
--  Table structure for `ask_artical_topic`
-- ----------------------------
DROP TABLE IF EXISTS `ask_artical_topic`;
CREATE TABLE `ask_artical_topic` (
  `artical_id` int(11) NOT NULL,
  `topic_id` int(11) NOT NULL,
  PRIMARY KEY (`artical_id`,`topic_id`),
  KEY `artical_id` (`artical_id`,`topic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='文章话题对应表';

-- ----------------------------
--  Records of `ask_artical_topic`
-- ----------------------------
BEGIN;
INSERT INTO `ask_artical_topic` VALUES ('1', '9'), ('2', '6'), ('2', '7'), ('2', '8');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ask_comment` VALUES ('1', '1', '1', '2', '测试评论', '2018-05-08 10:14:47', '2018-05-08 10:14:49', '0', '0');
COMMIT;
...
CREATE TABLE `ask_topic` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '底层/根话题 1:是 2:否',
...
-- ----------------------------
BEGIN;
INSERT INTO `ask_topic_relative` VALUES ('1', '9'), ('1', '10'), ('1', '13'), ('1', '20'), ('2', '1'), ('2', '5'), ('2', '6'), ('3', '1'), ('3', '2'), ('3', '31'), ('3', '33'), ('3', '37'), ('4', '1'), ('4', '7'), ('5', '2'), ('5', '3'), ('5', '4'), ('5', '6'), ('5', '7'), ('7', '4'), ('7', '9'), ('7', '11'), ('7', '14'), ('7', '16'), ('10', '1'), ('10', '4'), ('10', '32');
COMMIT;
